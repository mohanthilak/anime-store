  ...
  return (
    <div style={{backgroundImage: `url(${bg})`}} className='bg-cover px-6 md:px-12  h-[91vh] flex justify-center items-center'>
        <div className='bg-gray-100 bg-opacity-80 w-[80vw] lg:w-[70vw]  p-5 rounded-3xl  border-4 border-black flex items-center  '>
            <div className='w-1/2'>
                <div>
                    <h1 className='font-bold text-4xl'>Payable Amount: Rs. </h1>
                </div>
                <div className='my-5'>
                    <h1 className=' font-bold text-2xl'>Card Number</h1>
                    <p className='text-sm'>Enter the 16-digit card number on the card</p>
                    <input type="number" placeholder='1223122343159851'  className='rounded-lg mt-2 px-1 w-[100%] tracking-wider  text-2xl border-2 border-gray-500' />
                </div>
                <div className='my-5 flex items-end gap-4'>
                    ...
                    <input type="number" placeholder='12' className='mt-2 w-32 px-1 tracking-wider rounded-lg text-2xl border-2 border-gray-500' />
                    <h1 className='text-4xl'>/</h1>
                    <input type="number" placeholder='26' className='mt-2 w-32 px-1 tracking-wider rounded-lg text-2xl border-2 border-gray-500' />
                </div>
                <div className='my-5 flex items-end gap-4'>
                    <div className=''>
                    ...
                    <input type="number" placeholder='122' className='mt-2 w-[250px] px-1 tracking-wider rounded-lg text-2xl border-2 border-gray-500' />
                </div>
